...
public class Shooter {
    ...
    public void testingShooter(){
        ...
        if(shooting){
            ...
            // if((NetworkTableInstance.getDefault().getTable("limelight").getEntry("tx").getDouble(0.0) < 0.0) && (goLeft == false)){
            //     goRight = true;
            // }

            // if(goRight){
            //     Robot.drive.mecanumDrive.driveCartesian(0.0, 0.0, 0.15);
            //     if(NetworkTableInstance.getDefault().getTable("limelight").getEntry("tx").getDouble(0.0) > 0.0){
            //         Robot.drive.stopMotors();
            //         isTargetCenter = true;
            //     }
            // }

            // if((NetworkTableInstance.getDefault().getTable("limelight").getEntry("tx").getDouble(0.0) > 0.0) && (goRight == false)){
            //     goLeft = true;
            // }
            ...
            if((calculatedAngle != tempAngle)) { // && isTargetCenter){ // was shooterTimer.get() > 0.25
                ...
                if(canShoot){
                    Robot.intake.indexerMotor.set(-0.87);
                } else {
            ...
            Robot.intake.indexerMotor.set(0.0);
            tempAngle = calculatedAngle; // wasn't here before
